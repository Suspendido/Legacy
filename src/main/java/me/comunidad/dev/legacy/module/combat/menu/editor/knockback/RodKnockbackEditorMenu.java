 ...
 */
public class RodKnockbackEditorMenu extends Menu {

    private final String profileId;
    private final String base;

    // label, sub-path, step, min, max, material
    ...
    public RodKnockbackEditorMenu(MenuManager manager, Player player, String profileId) {
        super(manager, player, manager.getInstance().getLangManager().of(Lang.KB_ROD_EDITOR_TITLE, profileId), 27, false);
        this.profileId = profileId;
        this.base = "profiles." + profileId + ".knockback-rod.";
        ...
        for (int i = 0; i < FIELDS.length; i++) {
            ...
            buttons.put(slot, new Button() {
                ...
                public ItemStack getItemStack() {
                    ...
                    return new ItemBuilder(mat).setName("&6" + label).setLore(lore).toItemStack();
                }
