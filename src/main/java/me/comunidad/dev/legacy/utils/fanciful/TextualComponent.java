...
public abstract class TextualComponent implements Cloneable {
     ...
     */
    public abstract void writeJson(JsonWriter writer, UnaryOperator<String> replacer) throws IOException;
    ...
    private static final class ArbitraryTextTypeComponent extends TextualComponent implements ConfigurationSerializable {
        ...
        public void writeJson(JsonWriter writer, UnaryOperator<String> replacer) throws IOException {
            writer.name(getKey()).value(replacer.apply(getValue()));
        }
    ...
    private static final class ComplexTextTypeComponent extends TextualComponent implements ConfigurationSerializable {
        ...
        public void writeJson(JsonWriter writer, UnaryOperator<String> replacer) throws IOException {
            ...
            for (Map.Entry<String, String> jsonPair : _value.entrySet()) {
                writer.name(jsonPair.getKey()).value(replacer.apply(jsonPair.getValue()));
            }
            writer.endObject();
        }
